...
availableLanguages["en"].names["sv"] = "اللغة الإنجليزية";

//Swedish;
availableLanguages["sv"].names["en"] = "Arabic";
availableLanguages["sv"].names["de"] = "Arabisch";
availableLanguages["sv"].names["es"] = "Sueco";
availableLanguages["sv"].names["fr"] = "arabe";
...
availableLanguages["sv"].names["sv"] = "اللغة العربية";
...
availableLanguages["de"].names["sv"] = "اللغة الألمانية";
...
availableLanguages["fr"].names["sv"] = "اللغة الفرنسية";
...
modeNavigationString["en"] = "Mode: navigation. Shift/rectangle or mouse wheel for zooming./المستطيل أو عجلة الماوس للتكبير والتصغير /shift الوضع : التنقل. مفتاح";
...
modeNavigationString["sv"] = "Mode: navigering. Shift+rektangel eller skrollhjul för att zooma./المستطيل أو عجلة الماوس للتكبير والتصغير /shift الوضع : التنقل. مفتاح";
...
modeObjectIdentificationString["en"] = "Mode: object identification. Move the mouse over an object to identify it, click it to view its attribute data./الوضع: تحديد الكائن. حرّك الماوس فوق الكائن لتحديده، وانقر عليه لعرض بيانات سماته.";
...
modeObjectIdentificationString["sv"] = "Mode: identifiera objekt. Placera musen över ett objekt för att identifiera det, klicka för att visa dess attribut./الوضع: تحديد الكائن. حرّك الماوس فوق الكائن لتحديده، وانقر عليه لعرض بيانات سماته.";
...
modeMeasureDistanceString["en"] = "Mode: measure distance. Finish with double click./ الوضع: قياس المسافة. أنهِ العملية بنقرة مزدوجة";
...
modeMeasureDistanceString["sv"] = "Mode: mät avstånd. Avsluta med dubbelklick./ الوضع: قياس المسافة. أنهِ العملية بنقرة مزدوجة";

//mode measure area
var modeMeasureAreaString = new Array();
modeMeasureAreaString["en"] = "Mode: measure area. Finish with double click./ الوضع: قياس المساحة. أنهِ العملية بنقرة مزدوجة";
...
modeMeasureAreaString["sv"] = "Mode: mät yta. Avsluta med dubbelklick./ الوضع: قياس المساحة. أنهِ العملية بنقرة مزدوجة";
...
leftPanelTitleString["sv"] = "Information och verktyg/المعلومات والأدوات";

//title of search panel
var searchPanelTitleString = new Array();
searchPanelTitleString["en"] = "Search/بحث";
...
searchPanelTitleString["sv"] = "Sök/بحث";

//text of theme Switcher button
var mapThemeButtonTitleString = new Array();
mapThemeButtonTitleString["en"] = "Map themes/مواضيع الخريطة";
...
mapThemeButtonTitleString["sv"] = "Kartteman/مواضيع الخريطة";
...
mapPanelTitleString["en"] = "Map/رسم خريطة";
...
mapPanelTitleString["sv"] = "Karta/رسم خريطة";
...
layerTreeTitleString["sv"] = "Kartlager/طبقات الخريطة";

//title of background layers
var backgroundLayerTitleString = new Array();
backgroundLayerTitleString["en"] = "Background Layers/طبقات الخلفية";
...
backgroundLayerTitleString["sv"] = "Bakgrundslager/طبقات الخلفية";

//title of layer order panel
var layerOrderPanelTitleString = new Array();
layerOrderPanelTitleString["en"] = "Layer order and Opacity/ترتيب الطبقات والتعتيم";
...
layerOrderPanelTitleString["sv"] = "Lagerordning/ترتيب الطبقات والتعتيم";

//tooltip of layer settings button in layer order panel
var layerOrderPanelLayerSettingsTooltipString = new Array();
layerOrderPanelLayerSettingsTooltipString["en"] = "Settings/إعدادات";
...
layerOrderPanelLayerSettingsTooltipString["sv"] = "Inställningar/إعدادات";

//tooltip of remove layer button in layer order panel
var layerOrderPanelVisibilityChangeTooltipString = new Array();
layerOrderPanelVisibilityChangeTooltipString["en"] = "Change Layer Visibility/تغيير رؤية طبقة الخريطة";
...
layerOrderPanelMoveLayerTextString["en"] = "Move layer/نقل الطبقة لأعلى أو لأسفل";
...
layerOrderPanelMoveLayerTextString["sv"] = "Flytta lager/نقل الطبقة لأعلى أو لأسفل";

//tooltip of transparency sliders in layer order panel
var layerOrderPanelTransparencyTooltipString = new Array();
layerOrderPanelTransparencyTooltipString["en"] = "Transparency شفافية طبقة الخريطة {0}%";
...
layerOrderPanelTransparencyTooltipString["sv"] = "Transparens شفافية طبقة الخريطة {0}%";

//title of legend tab
var legendTabTitleString = new Array();
legendTabTitleString["en"] = "Legend/مفتاح الخريطة";
...
legendTabTitleString["sv"] = "Teckenförklaring/مفتاح الخريطة";

//legend loading message in legend tab
var legendTabLoadingString = new Array();
legendTabLoadingString["en"] = "Loading legend, please wait.../جاري تحميل مفتاح الخريطة، يُرجى الانتظار";
...
legendTabLoadingString["sv"] = "Laddar teckenförklaring, var vänlig vänta.../جاري تحميل مفتاح الخريطة، يُرجى الانتظار";
...
layerQueryable["en"] = "This layer is queryable / هذه الطبقة قابلة للاستعلام: ";
...
layerQueryable["sv"] = "Detta lager är sökbart / هذه الطبقة قابلة للاستعلام:  ";

//in case we need a yes
var yesString = new Array();
yesString["en"] = "yes/نعم";
...
coordinateSystemsString["en"] = "Available Coordinate Systems / أنظمة إحداثيات الخريطة";
...
coordinateSystemsString["sv"] = "Tillgängliga koordinatsystem / أنظمة إحداثيات الخريطة";

//metadata: geographic extent
var geographicExtentString = new Array();
geographicExtentString["en"] = "Geographic Extent/المدى الجغرافي";
...
geographicExtentString["sv"] = "Geografisk utsträckning/المدى الجغرافي";

//metadata: geographic extent
var westString = new Array();
westString["en"] = "west/غرب";
...
westString["sv"] = "väster/غرب";

//metadata: geographic extent
var eastString = new Array();
eastString["en"] = "east/شرق";
...
eastString["sv"] = "öster/شرق";

//metadata: geographic extent
var northString = new Array();
northString["en"] = "north/شمال";
...
northString["sv"] = "norr/شمال";

//metadata: geographic extent
var southString = new Array();
southString["en"] = "south/جنوب";
...
southString["sv"] = "söder/جنوب";

//attributes / fields
var attributesString = new Array();
attributesString["en"] = "Attributes / Fields الخصائص / الحقول";
...
attributesString["sv"] = "Attribut / Fält الخصائص / الحقول";
...
objectIdentificationTextLabel["en"] = "Object identification/تحديد الكائن ";
...
objectIdentificationTextLabel["sv"] = "Identifiera objekt/تحديد الكائن ";

//Coordinate text label (coordinate display in bottom toolbar of main map window)
var coordinateTextLabel = new Array();
coordinateTextLabel["en"] = "Coordinate / إحداثيات الخريطة:";
...
coordinateTextLabel["sv"] = "Koordinater / إحداثيات الخريطة:";
...
printCancelButtonTextString["en"] = "Cancel/إلغاء";
...
printCancelButtonTextString["sv"] = "Avbryt/إلغاء";

//export toolbar title string
var exportSettingsToolbarTitleString = new Array();
exportSettingsToolbarTitleString["en"] = "Export Settings - Enter width/height or create rectangle in map./إعدادات التصدير - أدخل العرض/الارتفاع أو قم بإنشاء مستطيل في الخريطة";
...
exportSettingsToolbarTitleString["sv"] = "Export Settings - Enter width/height or create rectangle in map./إعدادات التصدير - أدخل العرض/الارتفاع أو قم بإنشاء مستطيل في الخريطة"; //FIXME
...
exportWidthInputField["en"] = "Width/عرض:";
...
exportWidthInputField["sv"] = "Width/عرض:"; //FIXME

//export height input field
var exportHeightInputField = new Array();
exportHeightInputField["en"] = "Height/ارتفاع:";
...
exportHeightInputField["sv"] = "Height/ارتفاع"; //FIXME

//text label lock export width/height ratio
var exportLockAspectRatioText = new Array();
exportLockAspectRatioText["en"] = "Lock Aspect Ratio/نسبة العرض";
...
exportLockAspectRatioText["sv"] = "Lock Aspect Ratio/نسبة العرض"; //FIXME

//text label transparent
var exportTransparentOptionText = new Array();
exportTransparentOptionText["en"] = "Transparent/شفاف";
...
exportTransparentOptionText["sv"] = "Transparent/شفاف"; //FIXME
...
exportButtonTextString["en"] = "Export/تصدير";
...
exportButtonTextString["sv"] = "Export/تصدير"; //FIXME
...
acceptDXFDisclaimerButtonText["en"] = "Accept/قبول";
...
acceptDXFDisclaimerButtonText["sv"] = "Accept/قبول"; //FIXME

//DXF export disclaimer decline button
var declineDXFDisclaimerButtonText = new Array();
declineDXFDisclaimerButtonText["en"] = "Decline/عدم قبول";
...
declineDXFDisclaimerButtonText["sv"] = "Decline/عدم قبول"; //FIXME
...
DXFExportSymbologyScaleLabel["en"] = "Symbology Scale/مقياس الرمزية: ";
...
DXFExportSymbologyScaleLabel["sv"] = "Symbology Scale/مقياس الرمزية: "; //FIXME
...
DXFExportAreaLimitLabel["en"] = "Area limit for export/حد المنطقة للتصدير: ";
...
DXFExportAreaLimitLabel["sv"] = "Area limit for export/حد المنطقة للتصدير: "; //FIXME

//area limit for the DXF export label
var DXFExportCurrentAreaLabel = new Array();
DXFExportCurrentAreaLabel["en"] = "Current area المنطقة الحالية: ";
...
DXFExportCurrentAreaLabel["sv"] = "Current area المنطقة الحالية: "; //FIXME
...
objectIdentificationModeString["allLayers"]["en"] = "All layers/جميع الطبقات";
...
objectIdentificationModeString["allLayers"]["sv"] = "Alla lager/جميع الطبقات";

objectIdentificationModeString["activeLayers"] = new Array();
objectIdentificationModeString["activeLayers"]["en"] = "Active Layer/الطبقة النشطة";
...
objectIdentificationModeString["activeLayers"]["sv"] = "Aktiva lager/الطبقة النشطة";

//measure distance result prefix
var measureDistanceResultPrefixString = new Array();
measureDistanceResultPrefixString["en"] = "Distance (المسافة) ";
...
measureDistanceResultPrefixString["sv"] = "Avstånd (المسافة) ";

//distance prefix for result:
var measureAreaResultPrefixString = new Array();
measureAreaResultPrefixString["en"] = "Area (المسافة) ";
...
measureAreaResultPrefixString["sv"] = "Area (المسافة) ";
...
zoomRectangleTooltipString["en"] = "Zoom with rectangle/التكبير مع المستطيل";
...
zoomRectangleTooltipString["sv"] = "التكبير مع المستطيل";
...
navigationHistoryBackwardTooltipString["sv"] = "Navigationshistorik bakåt/محفوظات التنقل إلى الوراء";
...
navigationHistoryForwardTooltipString["sv"] = "Navigationshistorik frammåt/محفوظات التنقلإلى الأمام";
...
objIdentificationTooltipString["en"] = "Object identification (attribute data)/تحديد الكائن (جدول السمات)";
...
objIdentificationTooltipString["sv"] = "Identifiera objekt (attributdata)/تحديد الكائن (جدول السمات)";
...
measureDistanceTooltipString["en"] = "Measure distance/قياس المسافة على الخريطة";
...
measureDistanceTooltipString["sv"] = "Mät avstånd/قياس المسافة على الخريطة";

//Measure Area
var measureAreaTooltipString = new Array();
measureAreaTooltipString["en"] = "Measure area/قياس المساحة على الخريطة";
...
measureAreaTooltipString["sv"] = "Mät område/قياس المساحة على الخريطة";

//Print Map
var printMapTooltipString = new Array();
printMapTooltipString["en"] = "Print Map/طباعة الخريطة";
...
printMapTooltipString["sv"] = "Skriv ut karta/طباعة الخريطة";

//Print Map disabled
var printMapDisabledTooltipString = new Array();
printMapDisabledTooltipString["en"] = "Print disabled, no layout is defined in the QGIS project/تم تعطيل الطباعة (لا يوجد تخطيط طباعة محدد في المشروع)";
...
printMapDisabledTooltipString["sv"] = "Utskrift ej möjlig, ingen layout är skapad i QGIS projektet/تم تعطيل الطباعة (لا يوجد تخطيط طباعة محدد في المشروع)";
//Export Map
var exportMapTooltipString = new Array();
exportMapTooltipString["en"] = "Export Map as Raster/تصدير الخريطة كملف نقطي";
...
exportMapTooltipString["sv"] = "exportera kartan som rasterfil/تصدير الخريطة كملف نقطي"; //FIXME

//Export DXF
var exportDXFTooltipString = new Array();
exportDXFTooltipString["en"] = "Export map extent as DXF/تصدير الخريطة كملف dxf";
...
exportDXFTooltipString["sv"] = "Export map extent as DXF/تصدير الخريطة كملف dxf"; //FIXME

//Send permalink
var sendPermalinkTooltipString = new Array();
sendPermalinkTooltipString["en"] = "Email a link to this map/أرسل رابطًا إلى هذه الخريطة عبر البريد الإلكتروني";
...
sendPermalinkTooltipString["sv"] = "Eposta en länk till denna karta/أرسل رابطًا إلى هذه الخريطة عبر البريد الإلكتروني";
...
showHelpTooltipString["en"] = "Show Help/إظهار ملف المساعدة";
...
showHelpTooltipString["sv"] = "Visa hjälp/إظهار ملف المساعدة";
