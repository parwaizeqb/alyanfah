var gis_projects = {
	...
	"topics": [{
		"name": "Albaha University Male Hostel",
		"projects": [{
			"name": "Albaha University Male Hostel (Reload Map)", //name needs to correspond with the project title (Project Properties --> General --> Project Title)
			"projectpath": "C:/OSGeo4W/apache/htdocs/QGIS-Web-Client-master/projects/building/",
			"projectfile": "Al Baha University",
			"thumbnail": "Albaha-University.png",
			"format": "image/png",
			"visibleLayers": "hadoodbaha,hadoodjama",
/*
...
*/
		...
		"projects": [{
			"name": "Al Baha University (Reload Map)", //name needs to correspond with the project title (Project Properties --> General --> Project Title)
			"projectpath": "C:/OSGeo4W/apache/htdocs/QGIS-Web-Client-master/projects/aqlimi",
			"projectfile": "Albaha",
